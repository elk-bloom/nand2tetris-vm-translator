pub struct CPUState {
    /// empty String has semantic meaning, treated like a None. We avoid Option to avoid frequent String allocation by functions referencing this property
    pub const_or_predefined_a_register: String,
    /// empty String has semantic meaning, treated like a None. We avoid Option to avoid frequent String allocation by functions referencing this property
    pub const_or_predefined_d_register: String,
    // below don't really indicate CPU State but they're quite convenient to have here
